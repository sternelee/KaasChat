...
pub struct Capabilities {
    pub clients: HashMap<String, McpClientBox>,
    pub instructions: HashMap<String, String>,
    pub resource_capable_extensions: HashSet<String>,
    pub system_prompt_override: Option<String>,
    pub system_prompt_extensions: Vec<String>,
}
